...
public class PersonRepository2 extends IPersonRepository {
    ArrayList<Person> people = new ArrayList<>();
    
    public PersonRepository2() {
        this.people.add(new Person(1, "Maria", "Ferreira", 20));
        this.people.add(new Person(2, "Andre", "Bastos", 25));
    }
